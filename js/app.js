...
angular.module('ToDoApp', [])
    .config(function($httpProvider) {
        ...
        $httpProvider.defaults.headers.common['X-Parse-Application-Id'] = 'ocmIuKh1TpAwZWEUfXVLwMj6DbetWvA4jadabPYc';
        $httpProvider.defaults.headers.common['X-Parse-REST-API-Key'] = 'jVFSRwiJbNtZKopY2pAnTEqeks2HQvTYGRyWLOv6';
    })
    .controller('TasksController', function($scope, $http) {
        ...
        $scope.updateTask = function(task) {
            $http.put(tasksUrl + '/' + task.objectId, task)
                .success(function() {
                   //we could give some feedk to the user
